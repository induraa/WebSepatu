...
if (isset($_POST['submit'])) {
	...
	$koneksi -> query("INSERT INTO tb_produk 
				  (nama_produk, harga_produk, foto_produk, deskripsi_produk )
				   VALUES ('$_POST[nama_produk]', '$_POST[harga_produk]', '$namafoto' 
				           ,'$_POST[deskripsi]')");
			...
			<form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">  
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9">
                        ...
                        <small class="form-text text-muted">*ex : Nike Air Force</small>
                    </div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9">
                        ...
                        <small class="form-text text-muted">*ex : 1000000</small>
                    </div>
				</div>
