...
<html lang="en">
  <head>
    ...
    <title>ABC Shoes-Keranjang</title>
  </head>
  <body>
  ...
  <div class="container">
          ...
          <?php 
            $no = 1;
            foreach ($_SESSION['keranjang'] as $nama_produk => $jumlah) :  ?>

            <?php 
             
              $ambil = $koneksi->query("SELECT * FROM tb_produk WHERE nama_produk='$nama_produk'");
            ...
            ?>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a class="btn btn-danger" href="hapuskeranjang.php?id=<?php echo $nama_produk ?> ">Hapus</td>
                  </tr>
                </tbody>
              <?php $no++; ?>
        <?php endforeach ?>
